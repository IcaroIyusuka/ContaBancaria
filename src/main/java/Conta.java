...
public class Conta {
    ...
    public void um_cliente_especial_com_saldo_atual_de_reais(Integer int1) throws PendingException {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("for solicitar um saque no valor de {int} reias")
    public void for_solicitar_um_saque_no_valor_de_reias(Integer int1) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
